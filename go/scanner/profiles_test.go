...
// The curated default must stay much smaller than "all", and minimal smaller still.
...
// "Generic", the catch-all detector and dominant source of false positives, must
